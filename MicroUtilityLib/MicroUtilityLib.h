...
#ifdef ENABLE_WIN32_VISUAL_STYLES //Defined by default in source file "MicroUtilityLib.c"
#ifdef _M_IX86
...
MICROUTILITYLIB_API BOOL DownloadFileFromInternetW(LPCWSTR lpcwUrl, LPCWSTR lpcwNewFileName);
